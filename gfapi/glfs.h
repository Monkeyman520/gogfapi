...
int glfs_set_volfile_server(glfs_t *fs, const char *transport, const char *host,
                            int port) __THROW
...
int glfs_init(glfs_t *fs) __THROW GFAPI_PUBLIC(glfs_init, 3.4.0);
...
int glfs_fini(glfs_t *fs) __THROW GFAPI_PUBLIC(glfs_fini, 3.4.0);
...
int glfs_get_volumeid(glfs_t *fs, char *volid, size_t size) __THROW
 ...
 *
 */
int glfs_setfsuid(uid_t fsuid) __THROW GFAPI_PUBLIC(glfs_setfsuid, 3.4.2);

int glfs_setfsgid(gid_t fsgid) __THROW GFAPI_PUBLIC(glfs_setfsgid, 3.4.2);
...
glfs_fd_t *glfs_creat(glfs_t *fs, const char *path, int flags,
                      mode_t mode) __THROW GFAPI_PUBLIC(glfs_creat, 3.4.0);

int glfs_close(glfs_fd_t *fd) __THROW GFAPI_PUBLIC(glfs_close, 3.4.0);
...
ssize_t glfs_write(glfs_fd_t *fd, const void *buf, size_t count,
                   int flags) __THROW GFAPI_PUBLIC(glfs_write, 3.4.0);
...
ssize_t glfs_pread(glfs_fd_t *fd, void *buf, size_t count, off_t offset,
                   int flags, struct glfs_stat *poststat) __THROW
    GFAPI_PUBLIC(glfs_pread, 6.0);

ssize_t glfs_pwrite(glfs_fd_t *fd, const void *buf, size_t count, off_t offset,
                    int flags, struct glfs_stat *prestat,
                    struct glfs_stat *poststat) __THROW
    GFAPI_PUBLIC(glfs_pwrite, 6.0);
...
int glfs_preadv_async(glfs_fd_t *fd, const struct iovec *iov, int count,
                      off_t offset, int flags, glfs_io_cbk fn,
                      void *data) __THROW GFAPI_PUBLIC(glfs_preadv_async, 6.0);
...
ssize_t glfs_copy_file_range(struct glfs_fd *glfd_in, off64_t *off_in,
                             struct glfs_fd *glfd_out, off64_t *off_out,
                             size_t len, unsigned int flags,
                             struct glfs_stat *statbuf,
                             struct glfs_stat *prestat,
                             struct glfs_stat *poststat) __THROW
...
int glfs_ftruncate(glfs_fd_t *fd, off_t length, struct glfs_stat *prestat,
                   struct glfs_stat *poststat) __THROW
...
int glfs_fsync(glfs_fd_t *fd, struct glfs_stat *prestat,
               struct glfs_stat *poststat) __THROW
    GFAPI_PUBLIC(glfs_fsync, 6.0);

int glfs_fsync_async(glfs_fd_t *fd, glfs_io_cbk fn, void *data) __THROW
    GFAPI_PUBLIC(glfs_fsync_async, 6.0);

int glfs_fdatasync(glfs_fd_t *fd, struct glfs_stat *prestat,
                   struct glfs_stat *poststat) __THROW
...
int glfs_readlink(glfs_t *fs, const char *path, char *buf,
                  size_t bufsiz) __THROW GFAPI_PUBLIC(glfs_readlink, 3.4.0);
...
int glfs_closedir(glfs_fd_t *fd) __THROW GFAPI_PUBLIC(glfs_closedir, 3.4.0);
...
ssize_t glfs_listxattr(glfs_t *fs, const char *path, void *value,
                       size_t size) __THROW GFAPI_PUBLIC(glfs_listxattr, 3.4.0);
...
int glfs_fallocate(glfs_fd_t *fd, int keep_size, off_t offset,
                   size_t len) __THROW GFAPI_PUBLIC(glfs_fallocate, 3.5.0);

int glfs_discard(glfs_fd_t *fd, off_t offset, size_t len) __THROW
    GFAPI_PUBLIC(glfs_discard, 3.5.0);

int glfs_discard_async(glfs_fd_t *fd, off_t length, size_t lent, glfs_io_cbk fn,
                       void *data) __THROW
    GFAPI_PUBLIC(glfs_discard_async, 6.0);

int glfs_zerofill(glfs_fd_t *fd, off_t offset, off_t len) __THROW
    GFAPI_PUBLIC(glfs_zerofill, 3.5.0);

int glfs_zerofill_async(glfs_fd_t *fd, off_t length, off_t len, glfs_io_cbk fn,
                        void *data) __THROW
    GFAPI_PUBLIC(glfs_zerofill_async, 6.0);
...
int glfs_fchdir(glfs_fd_t *fd) __THROW GFAPI_PUBLIC(glfs_fchdir, 3.4.0);
...
glfs_fd_t *glfs_dup(glfs_fd_t *fd) __THROW GFAPI_PUBLIC(glfs_dup, 3.4.0);

void glfs_free(void *ptr) __THROW GFAPI_PUBLIC(glfs_free, 3.7.16);
 ...
 */
int glfs_sysrq(glfs_t *fs, char sysrq) __THROW GFAPI_PUBLIC(glfs_sysrq, 3.10.0);
 ...
 */
struct stat *glfs_xreaddirplus_get_stat(glfs_xreaddirp_stat_t *xstat) __THROW
 ...
 *  -1: FAILURE
 */
int glfs_xreaddirplus_r(glfs_fd_t *glfd, uint32_t flags,
...
glfs_t *glfs_upcall_get_fs(glfs_upcall_t *arg) __THROW
...
glfs_upcall_reason_t glfs_upcall_get_reason(glfs_upcall_t *arg) __THROW
 ...
 * glfs_upcall.
 */
void *glfs_upcall_get_event(glfs_upcall_t *arg) __THROW
 ...
 * -1: FAILURE
 */
int glfs_upcall_register(glfs_t *fs, uint32_t event_list, glfs_upcall_cbk cbk,
                         void *data) __THROW
 ...
 * -1: FAILURE
 */
int glfs_upcall_unregister(glfs_t *fs, uint32_t event_list) __THROW
...
int glfs_fsetattr(struct glfs_fd *glfd, struct glfs_stat *stat) __THROW
    GFAPI_PUBLIC(glfs_fsetattr, 6.0);

int glfs_setattr(struct glfs *fs, const char *path, struct glfs_stat *stat,
...
int glfs_set_statedump_path(struct glfs *fs, const char *path) __THROW
